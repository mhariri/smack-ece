 ...
 */
final class ApacheHTTPSenderSsl implements HTTPSender {
    ...
    private static synchronized HttpClient initHttpClient(final BOSHClientConfig config) {
        ...
        schemeRegistry.register(
            ...
            org.apache.http.conn.ssl.SSLSocketFactory sslFactory = new org.apache.http.conn.ssl.SSLSocketFactory(config.getSSLContext());
