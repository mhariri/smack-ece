...
/**
 * Interface for parser implementations to implement in order to abstract the business of XML parsing out of the Body class.  This
 * allows us to leverage a variety of parser implementations to gain performance advantages.
 */
